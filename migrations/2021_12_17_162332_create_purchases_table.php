...
class CreatePurchasesTable extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('purchases', function (Blueprint $table) {
            ...
            $table->unsignedDecimal('target_lowest_price')->default(0)->comment('产品最低价');
            $table->unsignedDecimal('target_highest_price')->default(0)->comment('产品最高价');
            $table->unsignedTinyInteger('ambiguous_price')->default(0)->comment('价格是否电议');
            $table->unsignedTinyInteger('show_target_price')->default(0)->comment('是否显示心理价位');
            ...
            $table->string('description', 255)->default('')->comment('求购描述');
            ...
            $table->string('address')->default('')->comment('求购地址');
